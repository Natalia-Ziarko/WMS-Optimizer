...
,p_page_mode=>'MODAL'
,p_step_title=>unistr('Zarz\0105dzaj u\017Cytkownikami')
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(94274828785032715084)
,p_plug_name=>'Form on Manage User Access'
,p_title=>unistr('Zarz\0105dzaj u\017Cytkownikami')
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(94274828894853715084)
,p_plug_name=>'Buttons'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(94274831624514715087)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(94274828894853715084)
,p_button_name=>'SAVE'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(94274832098693715087)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(94274829841182715086)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(94274831241719715086)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(94274832393398715087)
,p_name=>'P10012_ID'
,p_source_data_type=>'NUMBER'
,p_is_primary_key=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(94274828785032715084)
,p_item_source_plug_id=>wwv_flow_imp.id(94274828785032715084)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(94274832768606715088)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(94274833157760715088)
...
'select user_name disp, id ret',
'from APEX_APPL_ACL_USERS',
'where application_id = :P10012_APPLICATION_ID'))
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(94274833557671715088)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(94274834871512715097)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(94274829966038715086)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(94274829841182715086)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(94274830608806715086)
,p_event_id=>wwv_flow_imp.id(94274829966038715086)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(94274835123559715097)
,p_process_sequence=>10
,p_process_point=>'AFTER_HEADER'
,p_region_id=>wwv_flow_imp.id(94274828785032715084)
,p_process_type=>'NATIVE_FORM_INIT'
,p_process_name=>'Initialize form Manage User Access'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_internal_uid=>94274835123559715097
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(94274835547419715097)
...
,p_attribute_08=>'N'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_internal_uid=>94274835547419715097
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(94274835947799715098)
,p_process_sequence=>40
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_CLOSE_WINDOW'
,p_process_name=>'Close Dialog'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_internal_uid=>94274835947799715098
);
