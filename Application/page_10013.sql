...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(94274836367612715098)
,p_plug_name=>'Buttons'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(94274836440427715098)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(94274836593303715098)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(94274836367612715098)
,p_button_name=>'NEXT'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(94274838517765715099)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(94274836367612715098)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(94274839817230715100)
,p_branch_action=>'f?p=&APP_ID.:10014:&APP_SESSION.::&DEBUG.:RP,10014::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(94274836593303715098)
,p_branch_sequence=>10
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(94274840290657715100)
,p_name=>'P10013_ROLE'
,p_is_required=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(94274836440427715098)
,p_prompt=>'Roles'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(94274840659008715101)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(94274841067498715101)
...
,p_lov=>'.'||wwv_flow_imp.id(94274841163728715101)||'.'
,p_field_template=>wwv_flow_imp.id(86355354664424879074)
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'NO'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(94274838662366715099)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(94274838517765715099)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(94274839333170715100)
,p_event_id=>wwv_flow_imp.id(94274838662366715099)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(94274842174992715102)
...
,p_process_when_button_id=>wwv_flow_imp.id(94274836593303715098)
,p_internal_uid=>94274842174992715102
);
